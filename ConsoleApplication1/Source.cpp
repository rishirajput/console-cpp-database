...
int takeinput(int);
long double j, k, l;
const char defaultusername[20] = "happy", defaultpassword[20] = "always";
...
void timer(int);
void onlyenter();
char string1[10][30] = { "Start","Shutdown Pro-Ject" };
char string2[10][30] = { "New Task","Set up your system","Shutdown" };
char string3[10][30] = { "Shutdown","Reboot","Cancel" };
char string4[10][30] = { "App Launcher","Pro-Jet assistant","Shutdown Pro-Ject" };
char string5[10][30] = { "Change securekey","Manage applications","Shutdown Pro-Ject" };
char string6[10][30] = { "Take Help","About Pro-Ject","Shutdown Pro-Ject" };
char string7[10][30] = { "General Calculator","Mathematic Tables","Unit Calculator","Geometry Calculation ","Shutdown Pro-Ject" };
...
char string12[10][30] = { "Library Management","School Management","Shutdown Pro-Ject" };
...
loading:
	...
	gotoxy(7, 17);
	cout << "or Esc to undo this task request";
	gotoxy(46, 17);
	for (i = 0; i<2; i++)
	{
		useless = _getch();
	...
	case 8:
		...
		cout << "\n\n\n\t\t    .......((((((POWER SAVING MODE)))))).......";
		gotoxy(48, 25);
		cout << "You can now safely close Pro-Jet ";
		exit(0);
		break;
	case 10:boot();
	}}
...
void schoolmanagement()
{
	...
	cout << "\n                        xxxx ";
	cout << "\n                        xxxx ";
	cout << "\n   xxxxxxxxxxxxxxxxxxxxxxxxx                 >>( ' Pro-Jet ' )<<";
	cout << "\n   xxxxxxxxxxxxxxxxxxxxxxxxx";
	cout << "\n   xxxx";
	cout << "\n   xxxx";
	cout << "\n   xxxx";
...
// Apologize Function
void apologize(int a)
{
	gotoxy(16, 4);
	cout << "Program appologizes because";
	gotoxy(16, 5);
	cout << "this part of Project still needs to be developed,";
	gotoxy(16, 6);
	gotoxy(16, 7);
	cout << "Project user interface yet to be updated";
	gotoxy(16, 8);
	cout << "Input Enter key to go back";
	gotoxy(51, 10);
	onlyenter();
